...
Small overlapping windows used for precise retrieval.

Recommended:

- 8 to 15 seconds per chunk
- 2 to 4 seconds overlap
- align boundaries to transcript words when possible

Example:

```text
chunk_001: 00:00-00:12
chunk_002: 00:10-00:22
chunk_003: 00:20-00:32
```

Why:

- supports exact timestamp answers
- prevents missing information at boundaries
...
- create overlapping 8-15 second chunks
- align chunks to transcript where possible
- attach nearby words
- attach keyframes
- create stable `chunk_id`

Done when:

- every video has a chunk list
- chunks cover full duration
- no gaps unless video/audio is corrupted
- overlap is intentional and stored
